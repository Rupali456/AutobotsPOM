...
Customer Rate Quote
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_special_charge}
    click element  ${select_rate_line_type_special_charge}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value2}
    input text  ${units_element}  ${units_value2}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_high_cargo_value}
    click element  ${select_rate_line_type_high_cargo_value}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value3}
    input text  ${units_element}  ${units_value3}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_lift_gate}
    click element  ${select_rate_line_type_lift_gate}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value4}
    input text  ${units_element}  ${units_value4}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_linehaul}
    click element  ${select_rate_line_type_linehaul}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value5}
    input text  ${units_element}  ${units_value5}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_flat_rate}
    click element  ${select_rate_line_type_flat_rate}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value6}
    input text  ${units_element}  ${units_value6}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_tanker_endorsement}
    click element  ${select_rate_line_type_tanker_endorsement}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value7}
    input text  ${units_element}  ${units_value7}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_over_dimensional}
    click element  ${select_rate_line_type_over_dimensional}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value8}
    input text  ${units_element}  ${units_value8}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_white_glove}
    click element  ${select_rate_line_type_white_glove}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value9}
    input text  ${units_element}  ${units_value9}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_detention_loading}
    click element  ${select_rate_line_type_detention_loading}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value10}
    input text  ${units_element}  ${units_value10}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_detention_unloading}
    click element  ${select_rate_line_type_detention_unloading}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value11}
    input text  ${units_element}  ${units_value11}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_line_haul}
    click element  ${select_rate_line_type_line_haul}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value12}
    input text  ${units_element}  ${units_value12}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_blind_shipmemt}
    click element  ${select_rate_line_type_blind_shipmemt}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value13}
    input text  ${units_element}  ${units_value13}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_bonded_carrier}
    click element  ${select_rate_line_type_bonded_carrier}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value14}
    input text  ${units_element}  ${units_value14}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_border_crossing}
    click element  ${select_rate_line_type_border_crossing}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value15}
    input text  ${units_element}  ${units_value15}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_customs_fees}
    click element  ${select_rate_line_type_customs_fees}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value16}
    input text  ${units_element}  ${units_value16}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_driver_assist}
    click element  ${select_rate_line_type_driver_assist}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value17}
    input text  ${units_element}  ${units_value17}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_guaranteed_service}
    click element  ${select_rate_line_type_guaranteed_service}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value18}
    input text  ${units_element}  ${units_value18}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    wait until element is visible  ${select_rate_line_type_flat_rate}
    click element  ${select_rate_line_type_flat_rate}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value19}
    input text  ${units_element}  ${units_value19}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    page should contain element  ${Rate_Line_Flat_Rate}
    Verify Total Rate Of Rate Line Items
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_limited_access}
    click element  ${select_rate_line_type_limited_access}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value20}
    input text  ${units_element}  ${units_value20}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    wait until element is visible  ${select_rate_line_type_over_dimensional}
    click element  ${select_rate_line_type_over_dimensional}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value21}
    input text  ${units_element}  ${units_value21}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    page should contain element  ${Rate_Line_Over_Dimensional}
    Verify Total Rate Of Rate Line Items
    ...
    wait until element is visible  ${select_rate_line_type_tanker_endorsement}
    click element  ${select_rate_line_type_tanker_endorsement}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value22}
    input text  ${units_element}  ${units_value22}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    page should contain element  ${Rate_Line_Tanker_Endorsement}
    Verify Total Rate Of Rate Line Items
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_per_mile}
    click element  ${select_rate_line_type_per_mile}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value23}
    input text  ${units_element}  ${units_value23}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    page should contain element  ${add_rate_line_item_popup}
    click element  ${rate_line_type_element}
    wait until element is visible  ${select_rate_line_type_team_service}
    click element  ${select_rate_line_type_team_service}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value24}
    input text  ${units_element}  ${units_value24}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    ...
    wait until element is visible  ${select_rate_line_type_white_glove}
    click element  ${select_rate_line_type_white_glove}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value25}
    input text  ${units_element}  ${units_value25}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    page should contain element  ${Rate_Line_White_Glove}
    Verify Total Rate Of Rate Line Items
    ...
    wait until element is visible  ${destination_value_dallas_tbs}
    click element  ${destination_value_dallas_tbs}
    click element  ${equipment_element}
    ...
    wait until element is visible  ${select_rate_line_type_fuel_surcharge}
    click element  ${select_rate_line_type_fuel_surcharge}
    input text  ${rate_per_unit_element}  ${rate_per_unit_value31}
    input text  ${units_element}  ${units_value31}
    wait until element is enabled  ${add_rate_line_item_button}
    click element  ${add_rate_line_item_button}
    page should contain element  ${Rate_Line_Fuel_Surcharge}
    Verify Total Rate Of Rate Line Items
    ...
    #Customer Search by Name
    wait until element is visible  ${customer_name_element}
    input text    ${Customer_name_element}   ${Customer_Name}
    wait until element is enabled  ${submit_button}
    click element  ${Submit_Button}
    wait until element is visible  ${list_of_Customer}
